      ...
      <section className="hero is-info is-medium is-bold">
        <div className="hero-body">
          <div className="container has-text-centered">
            <h1 className="title">FAQ Application - Where all your questions are answered!</h1>
          </div>
        </div>
      </section>
                ...
                <div className="media">
                  <div className="media-content has-text-centered">
                    ...
                    <div className="has-text-centered mb-4 tags has-addons level-item">
                      <span className="tag is-rounded is-info">@melissaheying{" "}</span>
                      <span className="tag is-rounded">Est. November 13, 2020</span>
                    </div>
                  </div>
                </div>
